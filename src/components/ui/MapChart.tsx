    ...
    <div className="w-full h-full relative flex items-center justify-center">
        ...
        >
            <ZoomableGroup center={[-81, 33.8]} zoom={1} minZoom={1} maxZoom={5}>
                ...
                {/* Marker for Upstate SC / Greenville area approx */}
                ...
                {/* Visual Radius/Coverage Circle Overlay */}
                <circle cx={0} cy={0} r={0} fill="none" /> {/* Placeholder to avoid Marker issues if needed, but react-simple-maps Marker handles coords */}
                <Marker coordinates={[-82.3940, 34.8526]}>
